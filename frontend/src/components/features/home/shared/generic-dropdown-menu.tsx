...
export function GenericDropdownMenu<T>({
  ...
  return (
    <div className="relative">
      <div
        className={cn(
          "absolute z-10 w-full bg-white border border-gray-400 rounded-lg shadow-none",
      ...
      >
                ...
                <>
                  ...
                  {numberOfRecentItems > 0 &&
                    index === numberOfRecentItems - 1 && (
                      <div className="border-b border-gray-400 bg-white pb-1 mb-1 h-[1px]" />
                    )}
                </>
              ))}
            </>
        ...
        {stickyFooterItem && (
          <div className="border-t border-gray-400 bg-white p-1 rounded-b-lg">
            {stickyFooterItem}
          </div>
        )}
      </div>
