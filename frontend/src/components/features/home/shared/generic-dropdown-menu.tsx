...
export function GenericDropdownMenu<T>({
  ...
  return (
    <div className="relative">
      <div
        className={cn(
          "absolute z-10 w-full bg-[var(--attachment-bg)] border border-[#727987] rounded-lg shadow-none",
      ...
      >
                ...
                <>
                  ...
                  {numberOfRecentItems > 0 &&
                    index === numberOfRecentItems - 1 && (
                      <div className="border-b border-[#727987] bg-[var(--attachment-bg)] pb-1 mb-1 h-[1px]" />
                    )}
                </>
              ))}
            </>
        ...
        {stickyFooterItem && (
          <div className="border-t border-[#727987] bg-[var(--attachment-bg)] p-1 rounded-b-lg">
            {stickyFooterItem}
          </div>
        )}
      </div>
